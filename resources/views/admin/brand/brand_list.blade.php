		...
		<div class="pageTop">
			<div class="page">
				<img src="../admin/img/coin02.png" /><span><a href="{{url('admin/main')}}">首页</a>&nbsp;-&nbsp;<a
					href="javaScript:void(0)">品牌管理</a>&nbsp;-</span>&nbsp;意见管理
			</div>
		</div>
			...
			<div class="connoisseur">
				<div class="conform">
					<form>
						...
						<div class="cfD">
							<a class="addA addA1" href="{{route('brand_add')}}">添加品牌+</a>
						</div>
					</form>
				</div>
				<!-- banner 表格 显示 -->
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>{{$v->brand_id}}</td>
							<td><div class="onsImg">
									<img src="{{env('UPLOAD_URL')}}{{$v->brand_logo}}">
								</div></td>
							<td>{{$v->brand_name}}</td>
							<td>{{$v->brand_order}}</td>
							...
							<td><a href="{{url('brand/upd/'.$v->brand_id)}}"><img class="operation"
